...
<\body>
  ...
  *dessin
  ...
  <math|f<around*|(|x|)>=<dfrac|x<rsup|2>-1|x<rsup|2>>>. En étudiant le signe
  de <math|x<rsup|2>-1>, on déduit les variations de <math|f.>
  ...
  a pour réciproque <math|<dfrac|1|x>> sur <math|\<bbb-R\><rsub|+>> et
  <math|\<bbb-R\><rsub|->>
  ...
  Par récurrence sur <math|n>, on peut définir la dérivée <math|n<rsup|ieme>
  de f> : <math|f<rsup|<around*|(|n|)>>=<around*|(|f<rsup|<around*|(|n-1|)>>|)><rprime|'>>.
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      <vspace*|2fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-size|<quote|1.19>|I<space|2spc><with|font-series|<quote|bold>|math-font-series|<quote|bold>|Exercices>>
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
